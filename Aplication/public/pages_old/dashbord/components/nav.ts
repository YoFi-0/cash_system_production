...
const aside = async() => {
    ...
    return  _aside(
        ...
        _a(
            ...
            _i({classes:"fa-solid fa-folder-open"})
        ),
        _div(
            {
                classes:"servers"
            ...
            _div(
                ...
                ...images.map((value:any) => _a({href:`/dashbord/server?server_id=${value.server_id}`}, _img({src: value.server_icon})))
            ),
            _a(
                {
                    classes:"button",
        ...
        _a(
            ...
            _i({classes:"fa-solid fa-arrow-right-from-bracket"})
        ).onClick(async e => {
