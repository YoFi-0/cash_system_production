...
class Render_Log  {
    // user side
    public static My_Servers_Donations(server_list:any[]):YoFiElement[] {
        return server_list.map((value:any) => {
    ...
    public static Private_Donations(server_list:any[], renderData:any = localStorage_get("user_data")):YoFiElement[]{
            return server_list.map((value:any) => {
    ...
    public static Store_Payments(server_list:any[], renderData:any = localStorage_get("user_data")):YoFiElement[]{
        return server_list.map((value:any) => {
    ...
    // server side
    public static Donations(server_list:any[]):YoFiElement[] {
        return server_list.map((value:any) => {
    ...
    public static This_Store_Payments(server_list:any[]):YoFiElement[]{
        return server_list.map((value:any) => {
