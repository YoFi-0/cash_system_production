...
const renderIndex = async () => {
    ...
    _page(is_api_render_error ? _div({ classes: "inint_page" }) :
        _div({
            classes: "inint_page"
        }, my_Store_Payments_filtter_pubb_input(), privte_donations_filtter_pubb_input(), My_Servers_Donations_filtter_pubb_input(), _paypalInput(), _div({
            classes: "cards"
        }, UserSide(renderData.username, renderData.user_image, renderData.tag, renderData.pay_pal_email ? true : false), pagePathSide("Logs", "/images/log_img.png", "in this page you can see all your moves", "fff"), renderData.pay_pal_email ? PayPalSide(renderData.pay_pal_email) : PayPalSide()), _div({
            classes: "logs"
        }, _donation_logs({
