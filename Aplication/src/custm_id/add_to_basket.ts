...
export default new Custom_id('add_to_basket', async({interaction, client}) => {
    ...
    .setCustomId('add_to_basket__model')
    .setTitle(_$.custom_id.add_to_basket.model.addBasket);

    const input_1 = new discord.TextInputBuilder()
    .setCustomId('add_to_basket_row_1').setMaxLength(max_len.quantity)
    .setLabel(_$.custom_id.add_to_basket.model.quntty)
